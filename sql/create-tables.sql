...
-- ===============================================
CREATE TABLE khoa (
    ma_khoa CHAR(10) PRIMARY KEY,        -- Mã khoa, khóa chính
...
CREATE TABLE chuyen_nganh (
    ma_chuyen_nganh CHAR(10) PRIMARY KEY,       -- Mã chuyên ngành
    ten_chuyen_nganh NVARCHAR(100) NOT NULL,    -- Tên chuyên ngành
    ma_khoa CHAR(10) NOT NULL,                  -- Khoa quản lý chuyên ngành
...
CREATE TABLE khoa_hoc (
    ma_khoa_hoc CHAR(10) PRIMARY KEY,           -- Mã khóa học
...
CREATE TABLE giang_vien (
    ma_gv CHAR(10) PRIMARY KEY,                 -- Mã giảng viên
    ho_ten_gv NVARCHAR(100) NOT NULL,           -- Họ tên giảng viên
    ma_khoa CHAR(10) NOT NULL,                  -- Giảng viên thuộc khoa nào
...
CREATE TABLE phong_hoc (
    ma_phong CHAR(10) PRIMARY KEY,              -- Mã phòng học
...
-- ===============================================
CREATE TABLE hoc_ky (
    ma_hk CHAR(10) PRIMARY KEY,                 -- Mã học kỳ
...
CREATE TABLE mon_tien_quyet (
    ma_mh CHAR(20) NOT NULL,                    -- Môn học hiện tại
    ma_mh_tien_quyet CHAR(20) NOT NULL,         -- Môn học tiên quyết
...
CREATE TABLE lop_hoc_phan (
    ma_lop_hp CHAR(10) PRIMARY KEY,             -- Mã lớp học phần
    ma_mh CHAR(20) NOT NULL,                    -- Môn học
    ma_gv CHAR(10) NOT NULL,                    -- Giảng viên phụ trách
    ma_hoc_ky CHAR(10) NOT NULL,                -- Học kỳ mở lớp
    ma_phong CHAR(10) NOT NULL,                 -- Phòng học
    FOREIGN KEY (ma_mh) REFERENCES mon_hoc(ma_mh),
...
CREATE TABLE lich_hoc (
    ...
    ma_lop_hp CHAR(10) NOT NULL,                -- Lớp học phần
...
CREATE TABLE sinh_vien (
    ma_sv CHAR(15) PRIMARY KEY,                 -- Mã sinh viên
    ma_chuyen_nganh CHAR(10) NOT NULL,          -- Chuyên ngành
    ma_khoa_hoc CHAR(10) NOT NULL,              -- Khóa học
...
CREATE TABLE ket_qua (
    ma_lop_hp CHAR(10) NOT NULL,                -- Lớp học phần
    ma_sv CHAR(15) NOT NULL,                    -- Sinh viên
