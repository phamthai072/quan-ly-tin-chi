...
CREATE TABLE chuyen_nganh (
    ma_chuyen_nganh NVARCHAR(10) PRIMARY KEY,
    -- Mã chuyên ngành
    ten_chuyen_nganh NVARCHAR(100) NOT NULL,
    -- Tên chuyên ngành
...
CREATE TABLE khoa_hoc (
    ma_khoa_hoc NVARCHAR(10) PRIMARY KEY,
    -- Mã khóa học
    ten_khoa_hoc NVARCHAR(100) NOT NULL,
    -- Tên khóa học (ví dụ: Khóa 2018-2022)
...
CREATE TABLE giang_vien (
    ...
    -- Mã giảng viên
    ho_ten_gv NVARCHAR(100) NOT NULL,
    -- Họ tên giảng viên
    ma_khoa NVARCHAR(10) NOT NULL,
    -- Giảng viên thuộc khoa nào
    don_gia DECIMAL(12, 2) NOT NULL,
    -- Đơn giá dạy (tính lương)
...
-- ===============================================
CREATE TABLE hoc_ky (
    ma_hk NVARCHAR(10) PRIMARY KEY,
    -- Mã học kỳ
    ten_hk NVARCHAR(50) NOT NULL,
    -- Tên học kỳ (Ví dụ: Học kỳ 1, Học kỳ 2)
...
CREATE TABLE mon_hoc (
    ma_mh NVARCHAR(20) PRIMARY KEY,
    -- Mã môn học
    ten_mh NVARCHAR(100) NOT NULL,
    -- Tên môn học
    so_tin_chi INT NOT NULL CHECK (so_tin_chi > 0),
    -- Số tín chỉ > 0
    ma_chuyen_nganh NVARCHAR(10) NOT NULL,
    -- Môn học thuộc khoa nào
    loai NVARCHAR(20) NOT NULL CHECK (loai IN (N'cơ bản', N'chuyên ngành')),
    -- Loại môn học
...
CREATE TABLE mon_tien_quyet (
    ma_mh NVARCHAR(20) NOT NULL,
    -- Môn học hiện tại
    ma_mh_tien_quyet NVARCHAR(20) NOT NULL,
    -- Môn học tiên quyết
    PRIMARY KEY (ma_mh, ma_mh_tien_quyet),
    -- Khóa chính (kết hợp 2 cột)
...
CREATE TABLE lop_hoc_phan (
    ma_lop_hp NVARCHAR(10) PRIMARY KEY,
    -- Mã lớp học phần
    ma_mh NVARCHAR(20) NOT NULL,
    -- Môn học
    ma_gv NVARCHAR(10) NOT NULL,
    -- Giảng viên phụ trách
    ma_hoc_ky NVARCHAR(10) NOT NULL,
    -- Học kỳ mở lớp
...
CREATE TABLE lich_hoc (
    ma_lich_hoc NVARCHAR(10) PRIMARY KEY,
    -- ID tự tăng
    ma_lop_hp NVARCHAR(10) NOT NULL,
    -- Lớp học phần
    thu TINYINT NOT NULL CHECK (
        thu BETWEEN 2
        AND 8
    ),
...
CREATE TABLE sinh_vien (
    ...
    ma_chuyen_nganh NVARCHAR(10) NOT NULL,
    -- Chuyên ngành
    ma_khoa_hoc NVARCHAR(10) NOT NULL,
    -- Khóa học
    ho_ten_sv NVARCHAR(100) NOT NULL,
    -- Họ tên sinh viên
    he_dao_tao NVARCHAR(20) NOT NULL CHECK (he_dao_tao IN (N'cao đẳng', N'đại học')),
    -- Hệ đào tạo
    FOREIGN KEY (ma_chuyen_nganh) REFERENCES chuyen_nganh(ma_chuyen_nganh),
...
CREATE TABLE ket_qua (
    ma_lop_hp NVARCHAR(10) NOT NULL,
    -- Lớp học phần
    ma_sv NVARCHAR(15) NOT NULL,
    -- Sinh viên
    diem DECIMAL(4, 2) NULL CHECK (
        diem BETWEEN 0
        AND 10
    ),
    -- Điểm (0-10), cho phép NULL nếu chưa có
    PRIMARY KEY (ma_lop_hp, ma_sv),
    -- Khóa chính kép (mỗi SV chỉ có 1 kết quả trong lớp)
    FOREIGN KEY (ma_lop_hp) REFERENCES lop_hoc_phan(ma_lop_hp),
...
INSERT INTO
    cau_hinh (ten, gia_tri)
VALUES
    (N'TinChiTruot_CanhBao', N'5');

INSERT INTO
    cau_hinh (ten, gia_tri)
VALUES
    (N'GV_ToiDa_Lop_HK', N'8');

INSERT INTO
    cau_hinh (ten, gia_tri)
VALUES
    (N'GV_ToiThieu_Tiet', N'48');

INSERT INTO
    cau_hinh (ten, gia_tri)
VALUES
    (N 'MonNgoaiNganh_ToiDa', N'3');

INSERT INTO
    cau_hinh (ten, gia_tri)
VALUES
    (N'TinChi_ToiDa_HocKy', N'20');